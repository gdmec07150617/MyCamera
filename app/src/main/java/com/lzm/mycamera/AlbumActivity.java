        ...
        sel=new SensorEventListener() {
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                if(x>10&&System.currentTimeMillis()>startTime+1000)
                {
                    ...
                    flipper.setInAnimation(AnimationUtils.loadAnimation(AlbumActivity.this,android.R.anim.fade_in));
                    flipper.setOutAnimation(AnimationUtils.loadAnimation(AlbumActivity.this,android.R.anim.fade_out));
